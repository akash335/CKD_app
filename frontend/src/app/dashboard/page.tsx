...
const TABS: DashboardTab[] = [
  ...
  },
  {
    ...
    icon: (
      <svg className="h-4 w-4" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
        <path strokeLinecap="round" strokeLinejoin="round" d="M10.5 6.75h3m-7.5 0h.008v.008H6V6.75Zm12 0h.008v.008H18v-.008Zm-12 5.25h.008v.008H6V12Zm12 0h.008v.008H18V12Zm-12 5.25h.008v.008H6v-.008Zm12 0h.008v.008H18v-.008ZM8.25 4.5h7.5A2.25 2.25 0 0 1 18 6.75v10.5a2.25 2.25 0 0 1-2.25 2.25h-7.5A2.25 2.25 0 0 1 6 17.25V6.75A2.25 2.25 0 0 1 8.25 4.5Z" />
      </svg>
    ),
  },
  {
...
export default function DashboardPage() {
  ...
  useEffect(() => {
    if (role !== null && role !== "patient") router.replace("/doctor-dashboard");
  }, [role, router]);
  ...
  return (
    <DataPrefetchProvider>
      <AppShell>
        {/* Page heading */}
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6 animate-in fade-in slide-in-from-bottom-4 duration-500">
          <div>
