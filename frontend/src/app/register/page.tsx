...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-grid-pattern flex flex-col items-center justify-center px-4 py-8 theme-transition">
      {/* Ambient orbs */}
      <div className="pointer-events-none fixed inset-0 overflow-hidden">
        ...
        <div className="absolute bottom-0 right-1/4 h-64 w-64 rounded-full bg-emerald-500/[0.03] blur-3xl" />
      </div>
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                className={`w-full rounded-xl border px-4 py-3 text-sm theme-text placeholder:theme-text-faint outline-none transition-all focus:ring-2 focus:ring-sky-500/30 theme-transition ${
