...
export function ThemeToggle() {
  ...
  return (
    <button
      onClick={toggleTheme}
      className="relative flex h-8 w-8 items-center justify-center rounded-lg theme-transition hover:bg-[var(--bg-elevated-hover)] group"
      ...
      <svg
        className={`h-4 w-4 absolute transition-all duration-300 ${
          theme === "light"
            ...
            : "opacity-0 -rotate-90 scale-0 text-violet-500"
        }`}
        fill="none"
        viewBox="0 0 24 24"
        strokeWidth={2}
